...
Steps taken:
1.  Download files using [web_to_gcs.py](web_to_gcs.py)
2.  Ran SQL queries in this file:  [bigquery_hw3.sql](bigquery_hw3.sql)
...
- 0 bytes.  BigQuery can retrieve the row count from metadata, without scanning any data